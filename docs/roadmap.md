...
6. Build and inspect the safe Raw HID diagnostic overlay in `docs/diagnostic-firmware-v1.md`; do not enable bus access until the KD85 pinout and recovery path are understood.
